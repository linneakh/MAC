...
#import biom table
otu=import_biom("../../Data/ITS/feature-table-json.biom", taxa_are_rows = TRUE)

#import sample metadata
map = import_qiime_sample_data("../../Data/ITS/sample-metadata.txt")
#map$Experiment <-as.factor(map$Experiment)
#row.names(map) <- map$Description

#import taxnomy
taxa.frame = read.csv(file="../../Data/ITS/taxonomy.csv", header = TRUE, sep=",", 
...
mac.s <- subset_samples(mac, SampleID != "VB0889_092")
mac.s
...
mac.rhizo.top = subset_samples(mac.s, Allocation == "rhizo" &
                                Depth == "top")
...
#filter to zerio and rhizosphere and top
...
# all depths
total_counts <-sum(taxa_sums(mac))
threshold <- 0.00001*total_counts
mac.f.0 <- filter_taxa(mac, function(x) sum(x) > threshold, TRUE)
mac.f <- subset_samples(mac.f.0, sample_sums(mac.f.0) > 1000)
...
mac.topf.0 <- filter_taxa(mac.top, function(x) sum(x) > threshold.top, TRUE)
mac.topf <- subset_samples(mac.topf.0, sample_sums(mac.topf.0) > 1000)

mac.topf.ra = rarefy_even_depth(mac.topf, min(sample_sums(mac.topf)))

# top, no time 0
total_counts.top.post.0 <- sum(taxa_sums(mac.top.post.0))
threshold.top.post.0 <- 0.00001*total_counts.top.post.0
mac.topf.post.0.0 <- filter_taxa(mac.top.post.0, function(x) sum(x) > threshold.top.post.0, TRUE)
mac.topf.post.0 <- subset_samples(mac.topf.post.0.0, sample_sums(mac.topf.post.0.0) != 0)

mac.topf.post.0.ra = rarefy_even_depth(mac.topf.post.0, min(sample_sums(mac.topf.post.0)))

# bottom
total_counts.deep <- sum(taxa_sums(mac.deep))
threshold.deep <- 0.00001*total_counts.deep
mac.deepf.0 <- filter_taxa(mac.deep, function(x) sum(x) > threshold.deep, TRUE)
mac.deepf <- subset_samples(mac.deepf.0, sample_sums(mac.deepf.0) > 1000)
...
mac.rhizof.0 <- filter_taxa(mac.rhizo, function(x) sum(x) > threshold.rhizo, TRUE)
mac.rhizof <- subset_samples(mac.rhizof.0, sample_sums(mac.rhizof.0) > 1000)
...
mac.bulkf.0 <- filter_taxa(mac.bulk, function(x) sum(x) > threshold.bulk, TRUE)
mac.bulkf <- subset_samples(mac.bulkf.0, sample_sums(mac.bulkf.0) > 1000)
...
mac.top.no.0.f.0 <- filter_taxa(mac.rhizo.top, function(x) sum(x) > threshold.rhizo.top, TRUE)
...
(p <- plot_richness(mac.f.ra, "Time","Line", measures=alpha_meas))
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-time-line-depth.png")
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-plants-fertigation-depth.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-time-line2.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-fertigation-line2.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-allocation-line2.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-depth-allocation.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-allocation.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-time-line-rhizo.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-plants-fertigation-rhizo.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-time-line2-rhizo.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-fertigation-line2-rhizo.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)

#define and plot alpha diversity measurements on unrarefied samples
(p <- plot_richness(mac.rhizof.ra, "Depth","Line2", measures=alpha_meas))
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-line2-depth-rhizo.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-time-line-rhizo.top.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-plants-fertigation-rhizo.top.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-time-line2-rhizo.top.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.alpha
filename <- paste0("../../Figures/ITS/alpha-fertigation-line2-rhizo.top.png")
ggsave(filename,units=c('in'),width=7,height=5,dpi=1000,p.alpha)
...
p.phylum
filename <- paste0("../../Figures/ITS/phylum-time-line-depth.png")
...
p.phylum
filename <- paste0("../../Figures/ITS/phylum-fertigation-line-depth.png")
ggsave(filename,units=c('in'),width=12,height=10,dpi=1000,p.phylum)
...
p.phylum
filename <- paste0("../../Figures/ITS/phylum-line2--depth.png")
ggsave(filename,units=c('in'),width=12,height=10,dpi=1000,p.phylum)
...
p.phylum
filename <- paste0("../../Figures/ITS/phylum-line2-allocation.png")
ggsave(filename,units=c('in'),width=12,height=10,dpi=1000,p.phylum)
```
...
p <- ggplot(mac.rhizof.dat, aes(x=Line, y = Abundance, fill=Phylum)) 
...
p.phylum
filename <- paste0("../../Figures/ITS/phylum-line-depth-rhizo.png")
ggsave(filename,units=c('in'),width=12,height=10,dpi=1000,p.phylum)
...
mac.f.dat$Genus[mac.f.dat$Abundance < 0.04] <- "Genus < 4%"
...
p.genus
filename <- paste0("../../Figures/ITS/genus-time-line.png")
ggsave(filename,units=c('in'),width=20,height=12,dpi=1000,p.genus)
...
p.genus
filename <- paste0("../../Figures/ITS/genus-line2--depth.png")
ggsave(filename,units=c('in'),width=18,height=10,dpi=1000,p.genus)
...
p.genus
filename <- paste0("../../Figures/ITS/genus-line2-allocation.png")
ggsave(filename,units=c('in'),width=18,height=10,dpi=1000,p.genus)
```
...
mac.rhizof.dat$Genus[mac.rhizof.dat$Abundance < 0.04] <- "Genus < 4%"
...
p <- ggplot(mac.rhizof.dat, aes(x=Line, y = Abundance, fill=Genus)) 
...
p.genus
filename <- paste0("../../Figures/ITS/genus-line-rhizo.png")
ggsave(filename,units=c('in'),width=18,height=12,dpi=1000,p.genus)
...
methylotrophs = c("Cryptococcus" , "Trichosporon", "Ascomycota", "Saccharomyces", "Penicillium","Paecilomyces", "Oidiodendron", "Chytridiomycota", 
                  "Glomeromycota", "Rozellomycota", "Basidiomycota", "Ganoderma", "Syzygospora", "Zygomycota", "Mortierella", "Bionectria", "Rozellida",
                  "Leucosporidium")

#######plot paracoccus######################################

mac.f.dat.genus.cryp <- mac.f.dat %>%
 filter(Genus == "Cryptococcus")

p <- mac.f.dat.genus.cryp %>%
  ggplot(., aes(x=Time, y=Abundance, fill=Line2)) +
  geom_boxplot() +
  facet_wrap(~Line2)
p
ggsave("../../Figures/ITS/Trichosporon-time-line2.png", width=8, height=7, units='in', dpi=1000)

p <- mac.f.dat.genus.cryp %>%
  ggplot(., aes(x=Line2, y=Abundance, fill=Line2)) +
  geom_boxplot() 
p
ggsave("../../Figures/ITS/Trichosporon-line2.png", width=8, height=7, units='in', dpi=1000)
#
...
p <- mac.f.dat.genus.methyl %>%
  ...
  facet_wrap(~Line2)
p
ggsave("../../Figures/ITS/methylotrophs-time-line2.png", width=10, height=5, units='in', dpi=1000)
...
p
ggsave("../../Figures/ITS/methylotrophs-sum-line2.png", width=5, height=4, units='in', dpi=1000)

```

genus - top only - all taxa
```{r taxonomy genus, echo = FALSE}
...
p <- mac.f.dat.genus.methyl %>%
  ...
  facet_wrap(~Line2)
p
ggsave("../../Figures/ITS/methylotrophs-top-time-line2.png", width=10, height=5, units='in', dpi=1000)
...
p <- mac.f.dat.genus.methyl %>%
  ...
  geom_bar(aes(), stat = "identity")
p
ggsave("../../Figures/ITS/methylotrophs-top-sum-line2.png", width=5, height=4, units='in', dpi=1000)

```

genus - top only rhizo - all taxa
```{r taxonomy genus, echo = FALSE}
...
p <- mac.f.dat.genus.methyl %>%
  ...
  facet_wrap(~Line2)
p
ggsave("../../Figures/ITS/methylotrophs-top-rhizo-time-line2.png", width=10, height=5, units='in', dpi=1000)
...
p <- mac.f.dat.genus.methyl %>%
  ...
  geom_bar(aes(), stat = "identity")
p
ggsave("../../Figures/ITS/methylotrophs-top-rhizo-sum-line2.png", width=5, height=4, units='in', dpi=1000)
...
ord.plot.jaccard.line.depth <- (
  plot_ordination(
    ...
    geom_point(aes(color = Line2), size = 4) )#+
...
ord.plot.jaccard.line.depth
filename <- paste0("../../Figures/ITS/jaccard.png")
...
ord.plot.bray.line.depth
filename <- paste0("../../Figures/ITS/bray.png")
...
ord.plot.jaccard.line.depth
filename <- paste0("../../Figures/ITS/jaccard-time.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.jaccard.line.depth)
...
ord.plot.bray.line.depth
filename <- paste0("../../Figures/ITS/bray-time.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.bray.line.depth)
...
ord.plot.bray.line.depth <- (
  plot_ordination(
    ...
    geom_point(aes(color = Allocation), size = 4) )#+
    #geom_point(colour = "grey90", size = 1) +
    #scale_color_manual(breaks = c("Clitoria", "Piper", "Hibiscus"),
    #                   values = c("green4", "red", "blue"))
#)
...
ord.plot.bray.line.depth
filename <- paste0("../../Figures/ITS/bray-allocation.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.bray.line.depth)


#pairwise permanova
dist.bray <- phyloseq::distance(mac.f.ra, "bray")
dist.jacc <- phyloseq::distance(mac.f.ra, "jaccard")

sample_df <- as(sample_data(mac.f.ra), "data.frame")

pairwise.adonis(dist.bray, sample_df$Line2)
pairwise.adonis(dist.bray, sample_df$Depth)
pairwise.adonis(dist.bray, sample_df$Time)
...
ord.plot.jaccard.line.depth
filename <- paste0("../../Figures/ITS/jaccard-top.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.jaccard.line.depth)
...
ord.plot.bray.line.depth
filename <- paste0("../../Figures/ITS/bray-top.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.bray.line.depth)

#pairwise permanova
dist.bray <- phyloseq::distance(mac.topf.post.0.ra, "bray")
dist.jacc <- phyloseq::distance(mac.topf.post.0.ra, "jaccard")

sample_df <- as(sample_data(mac.topf.post.0.ra), "data.frame")
...
ord.plot.jaccard.line.depth
filename <- paste0("../../Figures/ITS/jaccard-deep.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.jaccard.line.depth)
...
ord.plot.bray.line.depth
filename <- paste0("../../Figures/ITS/bray-deep.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.bray.line.depth)

#pairwise permanova
dist.bray <- phyloseq::distance(mac.deepf.ra, "bray")
dist.jacc <- phyloseq::distance(mac.deepf.ra, "jaccard")

sample_df <- as(sample_data(mac.deepf.ra), "data.frame")
...
ord.plot.jaccard.line.depth
filename <- paste0("../../Figures/ITS/jaccard-rhizo.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.jaccard.line.depth)
...
ord.plot.bray.line.depth
filename <- paste0("../../Figures/ITS/bray-rhizo.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.bray.line.depth)
...
ord.plot.jaccard.line.depth
filename <- paste0("../../Figures/ITS/jaccard-rhizo-top.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.jaccard.line.depth)
...
ord.plot.bray.line.depth
filename <- paste0("../../Figures/ITS/bray-rhizo-top.png")
ggsave(filename,units=c('in'),width=8,height=8,dpi=1000,ord.plot.bray.line.depth)


```

## beta diversity- hi-lo - top only
```{r beta diversity, include = FALSE}
...
ord.plot.jaccard
filename <- paste0("../../Figures/ITS/jaccard-top-hi-lo.png")
...
ord.plot.bray
filename <- paste0("../../Figures/ITS/bray-top-hi-lo.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res)

```

##beta diversity statistics - hi vs lo - top only
```{r}
#create a bray curtis distance matrix
mac.top.hi.lo.f.ra_bray <- phyloseq::distance(mac.top.hi.lo.f.ra, method = "bray")

#making a data frame from the sample_data
sampledf <- data.frame(sample_data(mac.top.hi.lo.f.ra))

#running adonis test
adonis(mac.top.hi.lo.f.ra_bray ~ Line + Time + Line*Time, data = sampledf)


#create a jaccard distance matrix
mac.top.hi.lo.f.ra_jaccard <- phyloseq::distance(mac.hi.lo.no.zero.f.ra, method = "jaccard")

#making a data frame from the sample_data
sampledf <- data.frame(sample_data(mac.hi.lo.no.zero.f.ra))

#running adonis test
adonis(mac.top.hi.lo.f.ra_jaccard ~ Line + Time + Line*Time, data = sampledf)
...
ord.plot.jaccard
filename <- paste0("../../Figures/ITS/jaccard-hi-lo.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res)
...
ord.plot.bray
filename <- paste0("../../Figures/ITS/bray-hi-lo.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res)

```

##beta diversity statistics - hi vs lo
```{r}
#create a bray curtis distance matrix
...
## beta diversity- hi-lo -top-rhizo
```{r beta diversity, include = FALSE}
sample_data(mac.top.rhizo.hi.lo.f.ra)$Line = factor(sample_data(mac.top.rhizo.hi.lo.f.ra)$Line, levels = c("lo", "hi"))


my.ord.jaccard <- ordinate(
 physeq = mac.top.rhizo.hi.lo.f.ra,
  method = "PCoA",
  distance = "jaccard")
  #weighted=TRUE)
...
ord.plot.jaccard
filename <- paste0("../../Figures/ITS/jaccard-top-rhizo-hi-lo.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res)
...
ord.plot.bray
filename <- paste0("../../Figures/ITS/bray-top-rhizo-hi-lo.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res)
...
```{r}
#create a bray curtis distance matrix
mac.top.rhizo.hi.lo.f.ra_bray <- phyloseq::distance(mac.top.rhizo.hi.lo.f.ra, method = "bray")

#making a data frame from the sample_data
sampledf <- data.frame(sample_data(mac.top.rhizo.hi.lo.f.ra))

#running adonis test
adonis(mac.top.rhizo.hi.lo.f.ra_bray ~ Line + Time + Line*Time, data = sampledf)


#create a jaccard distance matrix
mac.top.rhizo.hi.lo.f.ra_jaccard <- phyloseq::distance(mac.top.rhizo.hi.lo.f.ra, method = "jaccard")

#making a data frame from the sample_data
sampledf <- data.frame(sample_data(mac.top.rhizo.hi.lo.f.ra))

#running adonis test
adonis(mac.top.rhizo.hi.lo.f.ra_jaccard ~ Line + Time + Line*Time, data = sampledf)
...
write.csv(asv_tax_tab, "../../Output/ITS/deseq2/asv_tax_asv.csv")
...
write.csv(asv_tax_tab_top, "../../Output/ITS/deseq2/asv_tax_asv_top.csv")

#top depth post 0
asv_tab_top_post_0 <- as.data.frame(abundances(mac.topf.post.0.ra)) # get asvs/otus
asv_tab_top_post_0$asv_id <- rownames(asv_tab_top_post_0) # add a new column for ids
#tax_tab <- as.data.frame(tax_table(x)) # get taxonomy note: can be slow
tax_tab_top_post_0 <- as(mac.topf.post.0.ra@tax_table,"matrix") # get taxonomy note as matrix
tax_tab_top_post_0 <- as.data.frame(tax_tab_top_post_0) # convert to data frame
tax_tab_top_post_0$asv_id <- rownames(tax_tab_top_post_0) # add a new column for ids
asv_tax_tab_top_post_0 <- tax_tab_top_post_0 %>% 
  left_join(asv_tab_top_post_0, by="asv_id") # join to get taxonomy and asv table

head(asv_tax_tab_top_post_0)[,1:8]

#add column with first 5 digits of OTU name and taxonomy
asv_tax_tab_top_post_0 <- asv_tax_tab_top_post_0 %>%
  unite(OTU, c(Kingdom, Phylum, Class, Order, Family, Genus, Species, asv_id), sep = "_", remove = TRUE)

write.csv(asv_tax_tab_top_post_0, "../../Output/ITS/deseq2/asv_tax_asv_top_post_0.csv")
...
write.csv(asv_tax_tab_deep, "../../Output/ITS/deseq2/asv_tax_asv_deep.csv")
...
write.csv(asv_tax_tab_rhizo, "../../Output/ITS/deseq2/asv_tax_asv_rhizo.csv")
...
write.csv(asv_tax_tab_rhizo.top, "../../Output/ITS/deseq2/asv_tax_asv_rhizo.top.csv")
...
cts.0 <- read.csv("../../Output/ITS/deseq2/asv_tax_asv.csv", header = TRUE, sep =",")
cts.0$X <- NULL

coldata <- read.delim("../../Data/ITS/sample-metadata-mac-only.txt", header = TRUE)
...
cts.top.0 <- read.csv("../../Output/ITS/deseq2/asv_tax_asv_top.csv", header = TRUE, sep =",")
cts.top.0$X <- NULL
cts.samples <- cts.top.0[,2:71]
cts.samples.names <- colnames(cts.samples)

coldata.top <- read.delim("../../Data/ITS/sample-metadata-mac-top-only.txt", header = TRUE)
...
#import count data, transform to matrix, import column metadata, check that its a data.frame (top post zero depth)
cts.top.post.0.0 <- read.csv("../../Output/ITS/deseq2/asv_tax_asv_top_post_0.csv", header = TRUE, sep =",")
cts.top.post.0.0$X <- NULL
cts.samples <- cts.top.post.0.0[,2:59]
cts.samples.names <- colnames(cts.samples)

coldata.top.post.0 <- read.delim("../../Data/ITS/sample-metadata-mac-top-post-0-only.txt", header = TRUE)

cts.top.post.0.02 <- as.matrix(cts.top.post.0.0)
row.names(cts.top.post.0.02) <- cts.top.post.0.02[,1]
cts.top.post.0.02 <- cts.top.post.0.02[,-1]

cts.top.post.0 <- matrix(as.numeric(cts.top.post.0.02),    # Convert to numeric matrix
                  ncol = ncol(cts.top.post.0.02))
cts.top.post.0.0$OTU = NULL
colnames(cts.top.post.0) <- colnames(cts.top.post.0.0)

row.names(cts.top.post.0) <- row.names(cts.top.post.0.02)
new_order = sort(colnames(cts.top.post.0),decreasing=TRUE)
cts.top.post.0 <- cts.top.post.0[, new_order]

row.names(coldata.top.post.0) <- coldata.top.post.0$new_ID
coldata.top.post.0 <- coldata[order(coldata.top.post.0$SampleID, decreasing = TRUE),]

coldata.top$SampleID <- NULL

#import count data, transform to matrix, import column metadata, check that its a data.frame (bottom depth)
cts.deep.0 <- read.csv("../../Output/ITS/deseq2/asv_tax_asv_deep.csv", header = TRUE, sep =",")
cts.deep.0$X <- NULL
cts.samples <- cts.deep.0[,2:62]
cts.samples.names <- colnames(cts.samples)

coldata.deep <- read.delim("../../Data/ITS/sample-metadata-mac-deep-only.txt", header = TRUE)
...
cts.rhizo.0 <- read.csv("../../Output/ITS/deseq2/asv_tax_asv_rhizo.csv", header = TRUE, sep =",")
cts.rhizo.0$X <- NULL
cts.samples <- cts.rhizo.0[,2:48]
cts.samples.names <- colnames(cts.samples)

coldata.rhizo <- read.delim("../../Data/ITS/sample-metadata-mac-rhizo-only.txt", header = TRUE)
...
cts.rhizo.top.0 <- read.csv("../../Output/ITS/deseq2/asv_tax_asv_rhizo.top.csv", header = TRUE, sep =",")
cts.rhizo.top.0$X <- NULL
cts.samples <- cts.rhizo.top.0[,2:24]
cts.samples.names <- colnames(cts.samples)

coldata.rhizo.top <- read.delim("../../Data/ITS/sample-metadata-mac-top-rhizo-only.txt", header = TRUE)
...
## Create deseq2 object to compare time 1 to 0 for isoprene treated columns only
...
plotPCA(vstcounts, intgroup=c("Line2"))

```

## find asvs that are up or down regulated at timepoint 1
...
write.csv(as.data.frame(res), "../../Output/ITS/deseq2/deseq_res.csv")
...
plot <- ggplot(res.df.for.plot, aes(x=id_ASV, y=log2FoldChange)) + 
  ...
  #ylim(-2.5, 2.5) +
  coord_flip() 
ggsave("../../Figures/ITS/deseq2-hi-vs-lo.png", dpi = 1000, width = 8, height = 10, plot)
...
## create deseq2 object for only top depth post time zero
```{r create_deseq1_object_top_depth}
#add psuedocount
cts.top.post.0 <- cts.top.post.0 + 1
...
dds.top <- DESeqDataSetFromMatrix(countData = cts.top.post.0,
                              colData = coldata.top.post.0,
                              design= ~ Line2)
```

## find asvs that are up or down regulated at timepoint 1 in top depth
...
#write results to file
write.csv(res.top, "../../Output/ITS/deseq2/deseq_res_top_post_0.csv")
...
plot <- ggplot(res.top.df.for.plot, aes(x=id_ASV, y=log2FoldChange)) + 
  ...
  #ylim(-2.5, 2.5) +
  coord_flip() 
ggsave("../../Figures/ITS/deseq2-hi-vs-lo-top.png", dpi = 1000, width = 8, height = 10, plot)
...
#write results to file
write.csv(res.deep, "../../Output/ITS/deseq2/deseq_res_deep.csv")
...
plot <- ggplot(res.deep.df.for.plot, aes(x=id_ASV, y=log2FoldChange)) + 
  ...
  #ylim(-2.5, 2.5) +
  coord_flip() 
ggsave("../../Figures/ITS/deseq2-hi-vs-lo-deep.png", dpi = 1000, width = 8, height = 10, plot)
...
#write results to file
write.csv(res.allocation, "../../Output/ITS/deseq2/deseq_allocation.csv")
...
plot <- ggplot(res.allocation.df.for.plot, aes(x=id_ASV, y=log2FoldChange)) + 
  ...
  #ylim(-2.5, 2.5) +
  coord_flip() 
ggsave("../../Figures/ITS/deseq2-rhizo-vs-bulk.png", dpi = 1000, width = 8, height = 10, plot)

```
## create deseq2 object to compare hi and lo in rhizo
```{r create_deseq1_object_top_depth}
#add psuedocount
cts.rhizo <- cts.rhizo + 1
...
#write results to file
write.csv(res.rhizo.line, "../../Output/ITS/deseq2/deseq_rhizo-line.csv")
...
plot <- ggplot(res.rhizo.line.df.for.plot, aes(x=id_ASV, y=log2FoldChange)) + 
  ...
  #ylim(-2.5, 2.5) +
  coord_flip() 
ggsave("../../Figures/ITS/deseq2-hi-vs-lo-rhizo-only.png", dpi = 1000, width = 8, height = 10, plot)
...
#write results to file
write.csv(res.rhizo.top.line, "../../Output/ITS/deseq2/deseq_rhizo.top-line.csv")
...
plot <- ggplot(res.rhizo.top.line.df.for.plot, aes(x=id_ASV, y=log2FoldChange)) + 
  ...
  #ylim(-2.5, 2.5) +
  coord_flip() 
ggsave("../../Figures/ITS/deseq2-hi-vs-lo-rhizo-top-only.png", dpi = 1000, width = 8, height = 10, plot)
```
